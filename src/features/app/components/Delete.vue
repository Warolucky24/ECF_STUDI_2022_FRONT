        ...
        <div class="relative bg-sky-800 rounded-lg shadow">
          ...
          <div class="p-6 text-center">
            <div class="flex flex-col content-center items-center">
              ...
              <div class="flex m-2">
                <div class="p-3 rounded-md bg-red-600 hover:bg-red-500 transition duration-300 cursor-pointer m-2 text-white" @click="goDelete">Confirmer</div>
                <div class="p-3 rounded-md bg-emerald-600 hover:bg-emerald-500 transition duration-300 cursor-pointer m-2 text-white" @click="emit('goClose')">Surtout pas !</div>
              </div>
            </div>
          </div>
        </div>
